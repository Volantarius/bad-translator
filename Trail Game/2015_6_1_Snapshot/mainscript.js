...
var pfood = {name:'Hunted Meat', vname:'pfood', weight:0.5, cost:1};

var npfoodCandy = {name:'Candy', vname:'npfoodCandy', weight:0.5, cost:1};

var clothingHats = {name:'Hats', vname:'clothingHats', weight:0.5, cost:1};

var animalOxen = {name:'Oxen', vname:'animalOxen', weight:45, cost:44};
//END OF ITEMS
...
function runThis() {
var viv = version + ' nonrelease . debug';
...
{action:"checkItem('objectThing');", name:"Test Thing"}/*,
...
tran:'background-color 0.4s linear', hide:'visible', life:500, canvas:[indyBEstoreOne, testDia, fadeOut]};
...
var trailGraves = [{text:"I HONK FOR CHOLERA", distance:40, deadname:'Tim', date:'3/3/1882'},
{text:"Watch out for leg measles!", distance:400, deadname:'Team Read', date:'4/12/1882'},
...
{name:"Team Green", color:"#080", age:9, morale:0, ill:[], deceased:false},
...
} else {playerTwo.style.color = '#f00';playerTwo.innerHTML = 'Dead';playerTwo.title = 'Dead from:';}
// THREE
...
} else {playerThree.style.color = '#f00';playerThree.innerHTML = 'Dead';playerThree.title = 'Dead from:';}
// FOUR
...
} else {playerFour.style.color = '#f00';playerFour.innerHTML = 'Dead';playerFour.title = 'Dead from:';}
// FIVE
...
} else {playerFive.style.color = '#f00';playerFive.innerHTML = 'Dead';playerFive.title = 'Dead from:';}
// SIX
...
} else {playerSix.style.color = '#f00';playerSix.innerHTML = 'Dead';playerSix.title = 'Dead from:';}

refreshPartyNames();
}

// ---- Date Stuff ----
var gameDate = new Date(1848, 10, 1);
